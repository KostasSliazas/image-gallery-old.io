...
f,this.D.innerText=Number(this.h)+1);if(this.g&&(this.g.src===c||this.g.src===n))return!1;this.g&&this.l.removeChild(this.g);this.l.className="spin7";this.L();0<f.indexOf(".svg")?(this.g=b.cloneNode(),this.g.removeAttribute("id"),this.g.removeAttribute("class")):this.g=d("img");this.g.onerror=function(t){t.target.onerror=null;t.target.src=c};this.g.onload=function(){this.U();this.A.innerText=this.g.src.split("/").pop()}.bind(this);k(this.l,this.g);this.g.src=n};a.M=function(b){const c=b.target;"IMG"===
c.tagName&&(this.h=-1<this.j.indexOf(c)?this.j.indexOf(c):0,this.show(),b.stopImmediatePropagation())};g=0<l.getElementsByClassName(a.J).length?l.getElementsByClassName(a.J):l.getElementsByTagName("body");e=[];for(var m=g.length-1;0<=m;m--)e.push(g[m]);for(g=e.length-1;0<=g;g--){m=e[g].getElementsByTagName("img");for(let b=0;b<m.length;b++)a.j.push(m[b])}if(e[0]&&"BODY"===e[0].tagName)l.body.onclick=function(b){a.M(b)};else for(g=e.length-1;0<=g;g--)e[g].onclick=function(b){a.M(b)};a.v&&(a.F=d("button"),
