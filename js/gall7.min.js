...
return this};a.close=function(){this.i.className="hide7";this.isActive=!1;l.documentElement.style.overflow="visible"};a.L=function(){this.left.className=0===this.h?"hide7":"";this.u.className=this.h===this.j.length-1?"hide7":""};a.show=function(){const b=this.j[this.h],c=b.src,f=c.split("/").pop();var m=f.split(".");m=m[0]+"."+(this.R||m[1]);m=0<f.indexOf(".svg")?c:c.replace(f,this.S+m);this.isActive||(this.isActive=!0,document.documentElement.style.overflow="hidden",this.i.className="");this.v&&
(this.A.innerText=f,this.D.innerText=Number(this.h)+1);if(this.g&&(this.g.src===c||this.g.src===m))return!1;this.g&&this.l.removeChild(this.g);this.l.className="spin7";this.L();0<f.indexOf(".svg")?(this.g=b.cloneNode(),this.g.removeAttribute("id"),this.g.removeAttribute("class")):this.g=d("img");this.g.onerror=function(p){p.target.onerror=null;p.target.src=c};this.g.onload=function(){this.U();const p=this.g.src;c!==p&&(this.A.innerText=p.split("/").pop())}.bind(this);k(this.l,this.g);this.g.src=m};
a.M=function(b){const c=b.target;"IMG"===c.tagName&&(this.h=-1<this.j.indexOf(c)?this.j.indexOf(c):0,this.show(),b.stopImmediatePropagation())};g=0<l.getElementsByClassName(a.J).length?l.getElementsByClassName(a.J):l.getElementsByTagName("body");e=[];for(var n=g.length-1;0<=n;n--)e.push(g[n]);for(g=e.length-1;0<=g;g--){n=e[g].getElementsByTagName("img");for(let b=0;b<n.length;b++)a.j.push(n[b])}if(e[0]&&"BODY"===e[0].tagName)l.body.onclick=function(b){a.M(b)};else for(g=e.length-1;0<=g;g--)e[g].onclick=
function(b){a.M(b)};a.v&&(a.F=d("button"),a.play=d("button"),a.o=d("div"),a.s=d("div"),a.A=d("span"),a.D=d("span"),a.H=d("span"),a.A.id="alts7",a.play.id="play7",a.o.id="foot7",a.s.id="onow7",a.H.id="down7",a.F.id="wdow7",a.D.id="stat7",k(a.s,a.A,a.F),k(a.i,a.s,a.o),k(a.o,a.play,l.createTextNode(a.j.length+"("),a.D,l.createTextNode(")")),k(a.F,a.H));const h={play7:function(){a.B?a.clear():a.G()},left7:function(){a.clear().T().show()},rigt7:function(){a.clear().right().show()},clos7:function(){a.clear().close()},
wdow7:function(){a.clear().P()}};h[" "]=h.play7;h.ArrowLeft=h.left7;h.ArrowRight=h.rigt7;h.Escape=h.clos7;let u,v,w;a.i.addEventListener("touchstart",function(b){u=b.touches[0].pageX;v=b.touches[0].pageY;w=new Date},{passive:!0});a.i.addEventListener("touchend",function(b){const c=b.changedTouches[0].pageX-u;b=b.changedTouches[0].pageY-v;const f=new Date-w;30<Math.abs(c)&&30>Math.abs(b)&&1E3>f&&(0>c?h.rigt7():h.left7())});q.addEventListener("keyup",t);a.i.onclick=t}})(window,document);
