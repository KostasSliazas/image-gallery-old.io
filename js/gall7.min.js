...
return this};a.close=function(){this.i.className="hide7";this.isActive=!1;l.documentElement.style.overflow="visible"};a.L=function(){this.left.className=0===this.h?"hide7":"";this.u.className=this.h===this.j.length-1?"hide7":""};a.show=function(){const b=this.j[this.h],c=b.src,f=c.split("/").pop();var n=f.split(".");const u=n[0]+"."+this.R||n[1];n=0<f.indexOf(".svg")?c:c.replace(f,this.S+u);this.isActive||(this.isActive=!0,document.documentElement.style.overflow="hidden",this.i.className="");this.v&&
(this.A.innerText=f,this.D.innerText=Number(this.h)+1);if(this.g&&(this.g.src===c||this.g.src===n))return!1;this.g&&this.l.removeChild(this.g);this.l.className="spin7";this.L();0<f.indexOf(".svg")?(this.g=b.cloneNode(),this.g.removeAttribute("id"),this.g.removeAttribute("class")):this.g=d("img");this.g.onerror=function(p){p.target.onerror=null;p.target.src=c};this.g.onload=function(){this.U();const p=this.g.src.split("/").pop();u!==p&&(this.A.innerText=p)}.bind(this);k(this.l,this.g);this.g.src=n};
a.M=function(b){const c=b.target;"IMG"===c.tagName&&(this.h=-1<this.j.indexOf(c)?this.j.indexOf(c):0,this.show(),b.stopImmediatePropagation())};g=0<l.getElementsByClassName(a.J).length?l.getElementsByClassName(a.J):l.getElementsByTagName("body");e=[];for(var m=g.length-1;0<=m;m--)e.push(g[m]);for(g=e.length-1;0<=g;g--){m=e[g].getElementsByTagName("img");for(let b=0;b<m.length;b++)a.j.push(m[b])}if(e[0]&&"BODY"===e[0].tagName)l.body.onclick=function(b){a.M(b)};else for(g=e.length-1;0<=g;g--)e[g].onclick=
...
wdow7:function(){a.clear().P()}};h[" "]=h.play7;h.ArrowLeft=h.left7;h.ArrowRight=h.rigt7;h.Escape=h.clos7;let v,w,x;a.i.addEventListener("touchstart",function(b){v=b.touches[0].pageX;w=b.touches[0].pageY;x=new Date},{passive:!0});a.i.addEventListener("touchend",function(b){const c=b.changedTouches[0].pageX-v;b=b.changedTouches[0].pageY-w;const f=new Date-x;30<Math.abs(c)&&30>Math.abs(b)&&1E3>f&&(0>c?h.rigt7():h.left7())});q.addEventListener("keyup",t);a.i.onclick=t}})(window,document);
